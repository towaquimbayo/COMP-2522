...
public class Window extends PApplet {
  ...
  ArrayList<FoodCharacter> removeFoodQueue = new ArrayList<FoodCharacter>();
  ...
  public void setup() {
    ...
    for (int i = 0; i < numberOfStartingFood; i++) {
      ...
      PVector foodPosition = new PVector(random(0, this.width), random(0, this.height));
...
//      }
   ...
   */
  public void addThreadSafeFood(FoodCharacter food) {
   ...
   * @param food consumed by player
   */
  void removeThreadSafeFood(FoodCharacter food) {
