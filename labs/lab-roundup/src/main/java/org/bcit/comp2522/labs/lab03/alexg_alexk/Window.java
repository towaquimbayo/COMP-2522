...
public class Window extends PApplet {
  ...
  public void setup() {
    ...
    addPlayer(player);
    Mouse mouse = Mouse.getInstance(this, player);
    addMouse(mouse);
    // Initialize food
   ...
   * Handles behaviour that occurs when the mouse is clicked.
   */
  @Override
  ...
  public void draw() {
    ...
    for (FoodCharacter g : removeFoodQueue) {
      removeThreadSafeFood(g);
    }
   ...
   *
   * @param mouse circle that follows the cursor
   */
  ...
  /**
   * Remove food from all the relevant arrays.
   *
   * @param food consumed by player
   */
  ...
  /**
   * Removes a food object from the Food arraylist.
   *
