...
public class Tail implements IDrawable {
  ...
  public boolean outOfBounds(Window window) throws TailOutOfBounds {
  ...
  public void move(Window window) throws TailOutOfBounds {
    if (outOfBounds(window)) {
      throw new TailOutOfBounds("Tail is outside the boundary window");
    }
  }
