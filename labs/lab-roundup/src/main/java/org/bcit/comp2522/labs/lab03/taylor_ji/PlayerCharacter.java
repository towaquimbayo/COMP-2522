...
public class PlayerCharacter extends AbstractCharacter {
  ...
  /**
   * Setter method for this.direction.
   *
   * @param dirIn new direction input
   */
  public void setDirection(PVector dirIn) {
    this.direction = dirIn;
  }

  /**
   * Removes food character collided with player character.
   *
   * @param c collided food character
   */
  @Override
