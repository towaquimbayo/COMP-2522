...
public class Q1_CostlyLinkedList<K, V> implements Iterable {
  /**
  ...
  private LinkedList<Q1_Node<K, V>> list;
  public Q1_CostlyLinkedList(int b) {
    this.currentBudget = b;
    this.list = new LinkedList<Q1_Node<K, V>>();
  }

  public void push(K key, V val, int cost) {
    Q1_Node<K, V> node = new Q1_Node<>(key, val);
    list.add(node);
    currentBudget--;
  }
...
//    list.iterator()
  ...
  public Iterator iterator() {
    return new Q1_CostlyLinkedListIterator<K, V>(this.list);
  }
}
